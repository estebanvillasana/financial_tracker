...
CREATE INDEX IF NOT EXISTS idx_movements_sub_category_id
	ON movements (sub_category_id);

CREATE INDEX IF NOT EXISTS idx_movements_repetitive_movement_id
	ON movements (repetitive_movement_id);
